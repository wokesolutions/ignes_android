...
public class PolyActivity extends AppCompatActivity
    ...
    public void createPolygon (LatLng [] points){

        // Add polygons to indicate areas on the map.
        Polygon polygon = MapActivity.mMap.addPolygon(new PolygonOptions()
                .clickable(true)
                .add(points));
        ...
        MapActivity.mMap.setOnPolygonClickListener(this);
    }
        ...
        switch (type) {
            ...
            case "A":
                ...
                polyline.setStartCap(
                        new CustomCap(
                                BitmapDescriptorFactory.fromResource(R.drawable.arrowupicon), 10));
                break;
            case "B":
